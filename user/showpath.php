                ...
                <div class="basic-table sec_2 form-shadow">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 table_basic1">
                            ...
                            <table class="responsive-table-input-matrix" id="myTable" >
                                <thead>
                                    <tr>
                                        ...
                                        <th>Pathology Id <i class="zmdi zmdi-caret-up"></i> <i class="zmdi zmdi-caret-down"></i></th>
                                        <th>User ID <i class="zmdi zmdi-caret-up"></i> <i class="zmdi zmdi-caret-down"></i></th>
                                        <th>Pathology Name<i class="zmdi zmdi-caret-up"></i> <i class="zmdi zmdi-caret-down"></i></th>
                                        ...
                                        <th>Gender <i class="zmdi zmdi-caret-up"></i> <i class="zmdi zmdi-caret-down"></i></th>
                            ...
                            $get_cat_pro = "select * from bookpath where u_id='$useerid'";
...
//}
                while($row=mysqli_fetch_array($run_cat_pro)){
                    ...
                    $patient_phone = $row['p_phone'];
                    $gendr = $row['gendr'];
                    $patient_dob = $row['p_dob'];
                    $patient_address = $row['p_address'];
                    $patient_date = $row['p_date'];
                    $patient_time = $row['p_time'];
                    $patient_desc = $row['p_desc'];
                    ...
                    ?>
                         ...
                         <tr>
                                        ...
                                        <td><?php echo $path_id ;?></td>
                                        <td><?php echo $user_id ;?></td>
                                        <td><?php echo $path_name ;?></td>
