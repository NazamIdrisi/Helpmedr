...
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				if(isset($_POST["submit"]) && isset($_POST["testid"]))
{
extract($_POST);
...
<form name="form1" method="post" action="add_questions.php" onSubmit="return ();">
...
echo "<option value='' selected>"; echo $testid; "</option>";
