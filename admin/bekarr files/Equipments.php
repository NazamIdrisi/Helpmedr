...
<body>
	...
	<div class="inner-banner">
		<div class="note">Our Equipments</div>
		<div class="site-map">
  ...
  <div id="ourHolder">
	...
	<div class="view view-two"> 
		...
		<div class="mask"> 
			<a class="btn-icon" name="btn-icon"  href="#"></a> 
			<a class="btn-icon2" href="#"></a> 
		</div>
	</div>
      <div class="port-span">
	      <h3>Dental Care</h3>
	      <span>treatment, health</span>
      </div>
    </div>
    <div class="item child">
		...
		<div class="mask"> 
	      ...
	      <h3>Diabet Treatment</h3>
	      <span>child, diabet</span>
      </div>
    </div>
